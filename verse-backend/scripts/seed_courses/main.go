...
type seedCourse struct {
	...
	ord      int
	hidden   bool
	category string // 빈 값이면 DB 기본값('topic') 사용
	verses   []verseRef
}
...
var courses = []seedCourse{
	...
	mkCourse(3, "word", "말씀", r{40, 4, 23}, r{40, 4, 24}, r{40, 4, 25}, r{44, 6, 4}, r{58, 4, 12}, r{19, 119, 103}, r{19, 119, 105}),
	mkCourse(4, "prayer", "기도", r{40, 6, 33}, r{40, 7, 7}, r{40, 7, 8}, r{41, 9, 29}, r{43, 14, 14}, r{24, 33, 3}),
	mkCourse(5, "holy-spirit", "성령", r{43, 3, 5}, r{44, 1, 8}, r{44, 2, 38}, r{46, 2, 10}, r{49, 5, 18}),
	mkCourse(6, "repentance", "회개", r{40, 3, 11}, r{47, 5, 17}, r{62, 1, 9}, r{66, 2, 16}, r{23, 1, 18}),
	mkCourse(7, "devil", "마귀", r{41, 16, 17}, r{49, 6, 11}, r{59, 4, 7}, r{60, 5, 8}, r{5, 28, 7}),
	mkCourse(8, "praise", "찬송", r{59, 5, 13}, r{19, 69, 30}, r{19, 69, 31}, r{19, 113, 3}, r{19, 150, 6}, r{23, 43, 21}),
	mkCourse(9, "evangelism", "전도", r{40, 11, 28}, r{40, 28, 19}, r{41, 8, 36}, r{41, 16, 15}, r{51, 4, 2}, r{51, 4, 3}, r{51, 4, 4}),
	mkCourse(10, "blessing", "축복", r{64, 1, 2}, r{1, 12, 3}, r{5, 8, 18}, r{5, 28, 8}, r{6, 1, 8}),
	mkCourse(11, "thanksgiving", "감사", r{50, 4, 6}, r{51, 4, 2}, r{52, 5, 16}, r{52, 5, 17}, r{52, 5, 18}, r{49, 5, 20}, r{19, 106, 1}),
	mkCourse(12, "healing", "치료", r{44, 3, 6}, r{59, 5, 15}, r{2, 15, 26}, r{19, 103, 1}, r{19, 103, 2}, r{19, 103, 3}, r{19, 103, 4}, r{19, 103, 5}, r{39, 4, 2}),
	mkCourse(13, "cross", "십자가", r{42, 14, 27}, r{45, 6, 6}, r{46, 2, 2}, r{48, 5, 24}, r{23, 53, 5}),
	mkCourse(14, "resurrection", "부활", r{40, 27, 53}, r{40, 28, 6}, r{43, 11, 25}, r{43, 11, 26}, r{46, 15, 16}, r{60, 1, 3}),
	mkCourse(15, "faith", "믿음", r{45, 10, 17}, r{55, 4, 7}, r{58, 11, 1}, r{59, 5, 15}, r{20, 3, 5}, r{20, 3, 6}),
	mkCourse(16, "hope", "소망", r{45, 5, 3}, r{45, 5, 4}, r{45, 12, 12}, r{46, 13, 13}, r{19, 23, 4}, r{19, 23, 5}, r{19, 39, 7}),
	mkCourse(17, "love", "사랑", r{43, 3, 16}, r{43, 13, 34}, r{43, 13, 35}, r{46, 13, 1}, r{48, 5, 22}, r{48, 5, 23}, r{64, 1, 2}),
	mkCourse(18, "god", "하나님", r{43, 3, 16}, r{43, 3, 17}, r{43, 4, 24}, r{45, 8, 14}, r{45, 8, 28}, r{23, 40, 28}),
	mkCourse(19, "jesus", "예수님", r{42, 19, 10}, r{43, 8, 12}, r{43, 10, 10}, r{43, 14, 6}, r{58, 13, 8}),
	mkCourse(20, "salvation", "구원", r{46, 1, 18}, r{49, 6, 17}, r{19, 3, 8}, r{19, 18, 2}, r{19, 50, 15}),
	mkCourse(21, "grace", "은혜", r{45, 3, 23}, r{45, 3, 24}, r{46, 15, 10}, r{47, 8, 9}, r{60, 4, 10}, r{5, 5, 10}),
	mkCourse(22, "power", "능력", r{41, 9, 23}, r{44, 19, 11}, r{50, 4, 13}, r{55, 1, 7}, r{23, 40, 29}),
	mkCourse(23, "humility", "겸손", r{40, 11, 29}, r{40, 23, 12}, r{49, 4, 2}, r{59, 4, 6}, r{20, 18, 12}),
	mkCourse(24, "obedience", "순종", r{44, 5, 29}, r{45, 12, 1}, r{60, 5, 5}, r{5, 13, 4}, r{23, 1, 19}),
	mkCourse(25, "peace", "평안", r{40, 11, 28}, r{40, 11, 29}, r{40, 11, 30}, r{43, 14, 27}, r{45, 14, 17}, r{50, 4, 6}, r{4, 6, 26}),
	mkCourse(26, "diligence", "성실", r{19, 25, 21}, r{19, 37, 3}, r{19, 89, 2}, r{19, 119, 30}, r{23, 11, 5}),
	mkCourse(27, "patience", "인내", r{45, 5, 3}, r{45, 5, 4}, r{59, 1, 3}, r{59, 1, 4}, r{59, 5, 11}, r{66, 14, 12}, r{18, 23, 10}),
	mkCourse(28, "heaven", "천국", r{40, 3, 2}, r{40, 4, 23}, r{40, 5, 3}, r{40, 7, 21}, r{66, 21, 18}),
	mkCourse(29, "faithfulness", "충성", r{40, 25, 23}, r{42, 16, 10}, r{48, 5, 22}, r{19, 101, 6}, r{20, 13, 17}),
	mkCourse(30, "holiness", "거룩", r{60, 1, 16}, r{3, 11, 45}, r{3, 20, 8}, r{19, 103, 1}, r{23, 6, 3}),
	mkCourse(31, "testimony", "증거", r{43, 1, 12}, r{43, 14, 6}, r{44, 16, 31}, r{45, 8, 16}, r{19, 42, 2}),
	mkCourse(32, "self-control", "절제", r{46, 7, 9}, r{46, 9, 25}, r{48, 5, 22}, r{48, 5, 23}, r{20, 23, 2}, r{20, 29, 11}),
}
...
func main() {
	...
	if err := seedCommentary(ctx, pool); err != nil {
		log.Fatalf("seed commentary: %v", err)
	}
}
...
func insertCourse(ctx context.Context, pool *pgxpool.Pool, co seedCourse) error {
	...
	err := pool.QueryRow(ctx, `
		INSERT INTO courses(slug, title, title_en, theme, ord, hidden, category)
		VALUES ($1, $2, $3, $4, $5, $6, COALESCE(NULLIF($7, ''), 'topic'))
		ON CONFLICT (slug) DO UPDATE SET hidden = EXCLUDED.hidden, title = EXCLUDED.title, title_en = EXCLUDED.title_en, category = EXCLUDED.category
		RETURNING id
	`, co.slug, co.title, nz(themeEn[co.title]), co.theme, co.ord, co.hidden, co.category).Scan(&courseID)
	if err != nil {

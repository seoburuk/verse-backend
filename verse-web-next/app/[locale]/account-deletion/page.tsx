    ...
    sections: [
      {
        ...
        p: [
          ...
          "이 절차는 로그인 방식(아이디/비밀번호 또는 Google 로그인)에 관계없이 동일하게 적용됩니다.",
        ],
      },
      {
        h: "2. 앱을 삭제했거나 로그인할 수 없는 경우",
        p: [
          "앱에 접근할 수 없는 경우, 가입 시 사용한 아이디(또는 Google 이메일)를 명시하여 dksk1234234@gmail.com 으로 삭제를 요청하실 수 있습니다.",
      ...
      },
      {
        ...
        p: [
          "삭제 즉시 다음 데이터가 파기됩니다: 아이디, 비밀번호(암호화된 값), 이름, 이메일(Google 로그인 시), 암송 진도·등급 기록, 책갈피, 앱 설정(테마·언어).",
    ...
    sections: [
      {
        ...
        p: [
          ...
          "This process is the same regardless of how you signed in (username/password or Google Sign-In).",
        ],
      },
      {
        h: "2. If you no longer have the app or can't sign in",
        p: [
          "If you can't access the app, you can request deletion by emailing dksk1234234@gmail.com and stating the username (or Google account email) used to sign up.",
      ...
      },
      {
        ...
        p: [
          "Deletion is immediate and destroys the following: username, password (stored encrypted), name, email (for Google Sign-In users), memorization progress and grade records, bookmarks, and app settings (theme, language).",

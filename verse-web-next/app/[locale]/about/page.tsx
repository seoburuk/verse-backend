...
const COPY: Record<Locale, { title: string; body: string[] }> = {
  ko: {
    title: "PIXBIBLE 소개",
    body: [
      "PIXBIBLE은 킹제임스 성경(KJV) 66권을 절 단위로 암송할 수 있도록 돕는 레트로 픽셀 스타일 학습 웹앱입니다.",
      ...
      "PIXBIBLE은 개인이 만든 서비스이며, 문의 사항은 앱 내 채널을 통해 남겨주시면 확인 후 답변드립니다.",
    ],
  },
  en: {
    title: "About PIXBIBLE",
    body: [
      "PIXBIBLE is a retro-pixel learning web app that helps you memorize the King James Version (KJV) Bible verse by verse.",
      ...
      "PIXBIBLE is an independently built app. If you have questions, please reach out through the contact channel in the app.",
    ],
  },
};
